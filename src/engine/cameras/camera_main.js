...
import CameraRuntime from "./camera_runtime.js";
...
class Camera {
    ...
    constructor(wcCenter, wcWidth, viewportArray, bound) {
        ...
        this.runtimeCamera = new CameraRuntime();
    }
    ...
    getRuntimeCam()
    {
        return this.runtimeCamera.getGameCam();
    }
    setRuntimeCam(isOn)
    {
        this.runtimeCamera.setToGameCam(isOn);
    }
    // #endregion
